...
public class TransfomationScript : MonoBehaviour
{
    ...
    void Update()
    {
        if(objScript.lastDragged != null){
            ...
            {
                if (objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.y > 0.45f)
                {
                    objScript.lastDragged.GetComponent<RectTransform>().transform.localScale = new Vector3(
                        objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x,
                        objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.y - 0.001f, 1f);
            ...
            {
                if (objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x < 0.85f)
                {
                    objScript.lastDragged.GetComponent<RectTransform>().transform.localScale = new Vector3(
                        objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.y,
                        objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x + 0.001f, 1f);
            ...
            {
                if (objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x > 0.45f)
                {
                    objScript.lastDragged.GetComponent<RectTransform>().transform.localScale = new Vector3(
                        objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.y,
                        objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x - 0.001f, 1f);
